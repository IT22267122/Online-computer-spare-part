...
<html lang="en">
  <head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/delete_css/style.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/delete_css/queries.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/delete_css/cart.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/delete_css/cartqueries.css">
    <title>Cart</title>
  </head>
